---
'@emrah.su/mongosh-llm-shared': minor
'@emrah.su/mongosh-llm-backend': minor
'@emrah.su/mongosh-llm-cli': minor
---

Add backend query execution so operators never need a database connection string.
